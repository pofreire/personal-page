...
import spinner from "../assets/spinner-duotone.svg";
...
function Menu() {
  ...
  function handleShow(tipo, loading) {
    setTipoAtual(tipo);
  }
  ...
  return (
    <>
        ...
        <Container>
          <div>
            <ul>
              <li>
                <a
                  href="https://www.facebook.com/pfreire0"
                  target="_blank"
                  without
              ...
              <li>
                <a
                  href="https://github.com/pofreire"
                  target="_blank"
                  without
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.instagram.com/pedr0freire/"
                  target="_blank"
                  without
                  rel="noopener noreferrer"
                >
      ...
      <Section id="projects">
        ...
        <ul>
          <li>
            <BtnSearch onClick={() => handleShow("all", true)}>All</BtnSearch>
          </li>
          <li>
            <BtnSearch onClick={() => handleShow("site", true)}>
              Sites
            </BtnSearch>
          </li>
          <li>
            <BtnSearch onClick={() => handleShow("system", true)}>
              Systems
            </BtnSearch>
          </li>
        </ul>
      ...
      <Section id="skills" style={{ background: "#363636" }}>
        <h2>Skills</h2>
      </Section>
