...
import {ArrowScroll, BtnSearch, Contato, H1, Profile, Projetos, Resume, Section} from "./styles";
...
function Menu() {
    ...
    const works = [
        {
            ...
            role: "Full Programmer Analyst • Sep 2021 - Currently",
            about: "Java/Angular Developer allocated to the Comptroller General of the Union (CGU).\n" +
                "Technologies used: Java 11, Spring, Angular, TypeScript, Rest Web Service, PostgreSQL, Docker.",
        },
        {
            location: "Vórtx DTVM",
            role: "Full Stack Developer • Mar 2021 - Sep 2021",
    ...
    return (
        <>
            ...
            <ArrowScroll onClick={() => scrollTop()} arrowScroll={showScroll}
            ...
            <Section id="about" style={{background: "#363636"}}>
                <Profile>
                    ...
                    <div>
                        ...
                        <p>
                            Well, I'm 29 years old, I have a bachelor's degree in Information
                            Systems from UniRedentor.
                            <br/>
                            <br/>
                            I currently work at Stefanini Brasil, it is a Brazilian multinational that operates in the
                            IT services sector. I am currently working on a project of the general controllership of the
                            union (CGU).
                        </p>
                        <p>
            ...
            <Section id="resume" style={{background: "#363636"}}>
                ...
                {/*                <li key={course.name}>*/}
                {/*                    <h3>{course.name}</h3>*/}
                {/*                    <p>{MyComponent(course.description)} </p>*/}
                {/*                </li>*/}
                {/*            ))}*/}
                {/*        </ul>*/}
                {/*    </div>*/}
            ...
            <Section id="contact">
                ...
                <Contato>
                    ...
                    <div className="side-contact" style={{width: "200px"}}>
                        <div>
                            <p>
                                <svg style={{width: "15px", marginRight: "10px"}} aria-hidden="true" focusable="false"
                                ...
                                <a target="_blank" without rel="noopener noreferrer" className="link-contact"
                                   href="mailto:30freire@gmail.com">30freire@gmail.com</a></p>
                            <p>
                                <svg style={{width: "15px", marginRight: "10px"}} aria-hidden="true" focusable="false"
                                ...
                                <a className="link-contact" target="_blank" without rel="noopener noreferrer"
                                   href="https://wa.me/5522981253123">+55(22)981253123</a></p>
                        </div>
                    </div>
                </Contato>
            </Section>
